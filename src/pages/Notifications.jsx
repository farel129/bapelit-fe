                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          {notification.surat_id && (
                            <Link
                              to={`/process/${notification.surat_id}`}
                              className="inline-flex items-center px-4 py-2 bg-white hover:bg-gray-50 border border-black/5 text-black rounded-xl text-sm font-medium transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                            >
