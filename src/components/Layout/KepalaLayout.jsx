...
const KepalaLayout = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'Daftar User', href: '/kepala/daftar-user', icon: User },
    { name: 'Papan Disposisi', href: '/kepala/leaderboard', icon: Star },
  ]
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#FDFCFB' }}>
      ...
      <div className={`fixed inset-0 z-50 lg:hidden ${sidebarOpen ? 'block' : 'hidden'}`}>
        <div className="fixed inset-0 bg-black/50 backdrop-blur-md" onClick={() => setSidebarOpen(false)} />
      ...
      {/* Top bar */}
      <div className="sticky w-full lg:hidden top-0 bg-white z-30 border-b border-[#EDE6E3] shadow-sm">
